...
class Server_Opers():
    ...
    def __init__(self ,container_name = ""):
      ...
      #  self.tags = tags
    #def run(self):
        #if self.tags == "host_stat":
        #    host_stat = self.retrieve_host_stat()
        #    self._queue.put(host_stat)
        #elif self.tags == "container_stat":
       # container_stat = self.retrieve_container_stat()
        #return container_stat
        #else:
        #    _queue.put("error tags")
...
#         """ 
#         usni1, usn1 = self._get_cpu()
#         time.sleep(2)
#         usni2, usn2 = self._get_cpu()  
...
#         return 100*cpuper
    ...
    #    cpuper=(usn2-usn1)/(usni2-usni1)
    #    self._logger.info("cpu load per second at this time :" + str(cpuper))
    #    return 100*cpuper
...
if __name__ == '__main__':
  ...
  #  contents_queue = multiprocessing.Queue()
  #  task_queue = multiprocessing.Queue()
  #  name = "/demo_centos"
    server = Server_Opers()
    print server.get_containers_id()
    #h_tags = "host_stat"
   # host_server = Server_Opers(name, h_tags, contents_queue)
    #host_server.start()
    #task_queue.put(host_server)
    #task_queue.put(container_server)

  #  c_tags = "container_stat"
    #container_server = Server_Opers(name)
    #container_server.start()

    #host_server.join()
    #container_server.join()
    
    #while contents_queue.empty() == False:
    #print contents_queue.get()
    print server.get_containers_alloc_mem()
    print server.retrieve_host_stat()
    print datetime.datetime.now()



#    print 'memfree:', server.memory_stat()
#    print 'disk:', server.disk_stat()
#    print 'load:', server.disk_loadavg()
#    print 'cpu:', server.get_cur_cpu_usage()
#    print 'cpu_stat:', server.cpu_info()
#    print 'net_stat:', server.get_cur_net_load() ,'kb'
#    print 'io_stat :' , server.disk_instant_load()
#    print "dh_h result: ", server.get_dev_name()

#    print "get server containers group memory resource :" ,server.containers_group_resource()

#    print "server container alloc memory:" ,server.get_container_alloc_mem() ,    "KB"
#    print "container network load :" ,server.get_container_network_load()
#    print "container disk load:" ,server.get_container_disk_load()
#     
#    server.search_pid_family_info()
